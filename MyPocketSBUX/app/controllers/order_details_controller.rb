class OrderDetailsController < ApplicationController
  ...
  private
    ...
    def order_detail_params
      params.require(:order_detail).permit(:order_id, :product_jan_code, :product_name, :size, :hot_or_iced, :reusable_cup, :ticket, :tax_exclude_total_price, :tax_exclude_custom_price, :total_calorie, :custom_calorie, :remarks)
    end
end
