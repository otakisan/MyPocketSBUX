class BeansController < ApplicationController
  ...
  private
    ...
    def bean_params
      params.require(:bean).permit(:name, :category, :jan_code, :price, :special, :notes, :notification, :growing_region, :processing_method, :flavor, :body, :acidity, :complementary_flavors)
    end
end
